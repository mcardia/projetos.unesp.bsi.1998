<?
	require("monitor/global.php");
	require("monitor/include/funcoes.php");
	require("monitor/include/db.php");
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr bgcolor="#CC0033">
		<td bgcolor="#CC0033" align="right"><img src="imagens/tp_monitor.gif" width="233" height="17" alt="" border="0"></td>
	</tr>
</table>
<? require("menu.html") ?>
<br>
				...
				<td>
					<table border=0 width="100%" cellpadding=1 cellspacing=1>
						...
						?>
								<table id="tabela">
									<tr>
										<td><font id="font_bold">Última análise em:</font></td>
										<td><font id="font_bold"><?=$dados["data"]?> <?=$dados["hora"]?></font></td>
									</tr>
									<tr>
										<td><font id="font_bold">Nº de Servidores:</font></td>
										<td><font id="font_bold"><?=$dados["total"]?></font></td>
									</tr>
									<tr>
										<td><font id="font_bold">Servidores com problemas:</font></td>
										<td><font id="font_bold"><?=$dados["total_erro"]?></font></td>
									</tr>
								</table>
							</td>
							<td>
