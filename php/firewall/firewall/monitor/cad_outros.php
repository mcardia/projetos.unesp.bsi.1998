...
<head>
	...
	<script>
		function limpa()
		{
			document.outros.id_server.value = 0;
			document.outros.acao.value      = "incluir";
			document.outros.gravar.value    = "Incluir";
			document.outros.port.value      = "8080";
		}
		...
		function check_form(form)
		{
			...
			if ( form.id_tcp.checked && form.port.value.length == 0 )
			{
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr bgcolor="#CC0033">
		<td bgcolor="#CC0033" align="right"><img src="../imagens/tp_monitor_outroserv.gif" width="305" height="17" alt="" border="0"></td>
	</tr>
</table>
<? require("menu.html") ?>
<form action="man_outros.php" method="post" target="mainFrame" name="outros" onsubmit="return check_form(this)">
			...
			<tr>
				<td>
					...
					<tr>
						...
						<td><input type="text"   name="port"     value="" class="Text" size="3"></td>
					</tr>
					<tr>
						<td colspan="5"><input type="checkbox" name="id_tcp" value="1" checked>&nbsp;<font id="font_black_b">Realizar teste de conexão tcp</font></td>
					</tr>
					</table>
				</td>
			</tr>
