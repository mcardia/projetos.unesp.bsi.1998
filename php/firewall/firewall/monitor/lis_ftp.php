...
<head>
	...
	<script>
		...
		{
			parent.cad.document.ftp.id_server.value = id;
			parent.cad.document.ftp.acao.value      = 'alterar';
			parent.cad.document.ftp.servidor.value  = servidor;
			parent.cad.document.ftp.host.value      = host;
			parent.cad.document.ftp.port.value = port;
			parent.cad.document.ftp.gravar.value    = "Alterar";
		}
		...
		function excluir()
		{
			...
			{
				parent.cad.document.ftp.id_server.value = id;
				parent.cad.document.ftp.acao.value = 'excluir';
				parent.cad.document.ftp.submit();
			}
		}
...
<?
	...
	$str_sql .= "FROM ftp as p LEFT JOIN status as s ON ( p.id_status = s.id ) ";
...
<form action="man_ftp.php" method="post" name="lista">
...
<?
	$db->db_close();
?>
<form action="lis_ftp.php" method="post" name="ordena">
